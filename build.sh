...
echo                                                                                                                           >> "$TEMPLATE"
echo      '#    mdabioinfo/sos-notebook start'                                                                                 >> "$TEMPLATE"
curl -sSL 'https://raw.githubusercontent.com/vatlab/SoS/master/development/docker-notebook/Dockerfile'     | tail --lines +8 - >> "$TEMPLATE"
echo      '#    mdabioinfo/sos-notebook end'                                                                                   >> "$TEMPLATE"
echo                                                                                                                           >> "$TEMPLATE"
